...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="//alimlive.com/css/styles.css" />
  <link rel="stylesheet" type="text/css" href="//alimlive.com/css/google_buttons.css" />
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Articles</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{route('article.index')}}"><i class="fa fa-circle-o"></i> View All</a></li>
                <li><a href="{{route('article.create')}}"><i class="fa fa-circle-o"></i> Add</a></li>
                <li><a href="{{route('type.index')}}"><i class="fa fa-circle-o"></i>View Types</a></li>
                <li><a href="{{route('type.create')}}"><i class="fa fa-circle-o"></i> Add Type</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('slider.index')}}"><i class="fa fa-circle-o"></i> View All</a></li>
                <li><a href="{{route('slider.create')}}"><i class="fa fa-circle-o"></i> Add</a></li>
              </ul>
            </li>
             <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Navigation</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{route('navigation.index')}}"><i class="fa fa-circle-o"></i> View All</a></li>
                <li><a href="{{route('navigation.create')}}"><i class="fa fa-circle-o"></i> Add</a></li>
              </ul>
            </li>
